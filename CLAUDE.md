...
세션을 시작할 때, 아래 "내 프로필"의 **이름/역할이 아직 비어 있으면**(= 이 워크스페이스를 막 클론한 첫 사용자) 다음 톤으로 **짧게 인사**하며 시작한다. 이미 프로필이 채워져 있으면 인사는 생략하고 평소처럼 바로 본론으로 간다.

> ☕ **Make Me Time** — *Amy's been busy so you don't have to.*
>
> 환영해요! 여기는 AI와 함께 일하는 작업공간이에요. 처음이라면 **"워크스페이스 세팅해줘"** 한마디면 시작됩니다. 천천히 따라오시면 돼요.
